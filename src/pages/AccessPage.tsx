    ...
    <div className="min-h-screen">
      ...
      <div className="relative h-64 md:h-80 bg-cover bg-center flex items-center justify-center" 
        ...
        <div className="text-center text-white z-10 px-4">
          <h1 className="text-4xl md:text-5xl font-serif font-bold mb-2">アクセス情報</h1>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="flex flex-col md:flex-row">
              ...
              <div className="md:w-1/3 p-6 bg-natural-light">
                <h2 className="text-2xl font-bold mb-3 text-primary-dark">山の民宿「木香」</h2>
                <p className="text-gray-700 mb-4">
                  〒XXX-XXXX<br />
                  〇〇県〇〇市〇〇町山路123-45
                </p>
                <div className="space-y-2">
                  <p className="text-gray-700"><span className="font-bold">電話：</span> 0X0-XXXX-XXXX</p>
                  <p className="text-gray-700"><span className="font-bold">メール：</span> info@yamaminshuku.jp</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-natural-light">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-serif font-bold mb-10 text-primary-dark text-center">交通手段</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="text-4xl mb-4 text-accent">🚗</div>
              <h3 className="text-xl font-bold mb-4 text-primary-dark">お車でお越しの場合</h3>
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                <p className="text-gray-700"><span className="font-bold">駐車場：</span> 15台（無料）</p>
              </div>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="text-4xl mb-4 text-accent">🚅</div>
              <h3 className="text-xl font-bold mb-4 text-primary-dark">電車・バスでお越しの場合</h3>
              <ul className="list-disc pl-5 mb-4 space-y-2 text-gray-700">
              ...
              <div className="mt-4 pt-4 border-t border-gray-200">
                <p className="text-gray-700"><span className="font-bold">送迎サービス：</span> 15:00〜17:00（要予約）</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-serif font-bold mb-10 text-primary-dark text-center">周辺地図・アクセスマップ</h2>
          <div className="flex flex-col md:flex-row gap-8 items-center">
            ...
            <div className="md:w-1/2">
              <h3 className="text-xl font-bold mb-4 text-primary-dark">ご案内</h3>
      ...
      <section className="py-16 bg-natural-light">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-serif font-bold mb-10 text-primary-dark text-center">周辺観光情報</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-1">
              <h3 className="text-xl font-bold mb-4 text-primary-dark">観光スポット</h3>
              <ul className="space-y-3">
                <li className="flex justify-between items-center py-2 border-b border-gray-200">
                  <span className="font-medium text-gray-700">〇〇滝</span>
                  <span className="text-sm bg-natural px-2 py-1 rounded">車で15分</span>
                </li>
                <li className="flex justify-between items-center py-2 border-b border-gray-200">
                  <span className="font-medium text-gray-700">△△温泉</span>
                  <span className="text-sm bg-natural px-2 py-1 rounded">車で20分</span>
                </li>
                <li className="flex justify-between items-center py-2 border-b border-gray-200">
                  <span className="font-medium text-gray-700">××高原</span>
                  <span className="text-sm bg-natural px-2 py-1 rounded">車で30分</span>
                </li>
                <li className="flex justify-between items-center py-2 border-b border-gray-200">
                  <span className="font-medium text-gray-700">□□神社</span>
                  <span className="text-sm bg-natural px-2 py-1 rounded">徒歩30分</span>
                </li>
                <li className="flex justify-between items-center py-2 border-b border-gray-200">
                  <span className="font-medium text-gray-700">◇◇美術館</span>
                  <span className="text-sm bg-natural px-2 py-1 rounded">車で40分</span>
                </li>
              </ul>
            </div>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="bg-primary-light bg-opacity-20 p-6 rounded-lg shadow-md max-w-3xl mx-auto">
            <h3 className="text-xl font-bold mb-4 text-primary-dark">ご宿泊のお客様へのご案内</h3>
            <div className="space-y-4 text-gray-700">
              <p>
                <span className="font-bold">チェックイン：</span> 15:00〜18:00<br />
      ...
      <section className="py-16 bg-natural-light">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-serif font-bold mb-6 text-primary-dark text-center">お問い合わせ</h2>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                <h3 className="text-xl font-bold mb-3 text-primary-dark">お電話</h3>
                <p className="text-lg font-semibold mb-1">0X0-XXXX-XXXX</p>
                <p className="text-gray-600 text-sm">(受付時間：9:00〜18:00)</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                <h3 className="text-xl font-bold mb-3 text-primary-dark">メール</h3>
                <p className="text-lg font-semibold mb-1">info@yamaminshuku.jp</p>
