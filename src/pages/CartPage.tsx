  ...
  if (cartItems.length === 0) {
    return (
      <div className="max-w-4xl mx-auto my-10 px-5 text-center py-16">
        <h1 className="text-3xl font-serif font-bold mb-8 text-primary-dark">
          ショッピングカート
        </h1>
        <p className="text-gray-700 mb-8">カートに商品がありません。</p>
        <Link
          to="/products"
          className="inline-block bg-transparent border border-primary text-primary hover:bg-natural hover:text-primary-dark py-2 px-6 rounded transition-colors"
        >
          商品一覧に戻る
        </Link>
      </div>
    ...
    <div className="max-w-4xl mx-auto my-10 px-5">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        {cartItems.map((item) => (
          <div
            key={item.product.id}
            className="flex flex-col md:flex-row items-start md:items-center gap-6 py-5 border-b border-natural last:border-b-0"
          >
            ...
            <div className="flex-grow">
              ...
              <p className="text-accent-dark font-semibold mb-2">
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-4">
          <Link
            to="/products"
            className="inline-block bg-transparent border border-primary text-primary hover:bg-natural hover:text-primary-dark py-2 px-6 rounded text-center transition-colors"
          >
            買い物を続ける
          </Link>
          <Link
            to="/checkout"
            className="inline-block bg-accent hover:bg-accent-dark text-white py-2 px-6 rounded text-center transition-colors"
          >
            購入手続きへ進む
          </Link>
        </div>
