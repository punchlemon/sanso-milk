    ...
    <div className="min-h-screen">
      ...
      <div className="relative h-64 md:h-80 bg-cover bg-center flex items-center justify-center" 
        ...
        <div className="text-center text-white z-10 px-4">
          <h1 className="text-4xl md:text-5xl font-serif font-bold mb-2">施設案内</h1>
          <p className="text-lg md:text-xl">山の民宿「木香」が提供する快適な空間と体験</p>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-serif font-bold mb-8 text-primary-dark text-center">お部屋</h2>
          ...
          <div className="space-y-12">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col md:flex-row">
              ...
              <div className="md:w-2/3 p-6">
                <h3 className="text-2xl font-bold mb-2 text-primary-dark">和室</h3>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col md:flex-row">
              ...
              <div className="md:w-2/3 p-6">
                <h3 className="text-2xl font-bold mb-2 text-primary-dark">洋室</h3>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col md:flex-row">
              ...
              <div className="md:w-2/3 p-6">
                <h3 className="text-2xl font-bold mb-2 text-primary-dark">特別室「山帰来」</h3>
      ...
      <section className="py-16 bg-natural-light">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-serif font-bold mb-10 text-primary-dark text-center">お食事</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-serif font-bold mb-10 text-primary-dark text-center">お風呂</h2>
      ...
      <section className="py-16 bg-natural-light">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-serif font-bold mb-8 text-primary-dark text-center">体験活動</h2>
          <div className="max-w-3xl mx-auto mb-12 text-center">
            <p className="text-gray-700">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-4">
                <h3 className="text-lg font-bold mb-2 text-primary-dark">山菜採り体験</h3>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-4">
                <h3 className="text-lg font-bold mb-2 text-primary-dark">薪割り体験</h3>
                <p className="text-gray-700 text-sm">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-4">
                <h3 className="text-lg font-bold mb-2 text-primary-dark">陶芸体験</h3>
                <p className="text-gray-700 text-sm">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-4">
                <h3 className="text-lg font-bold mb-2 text-primary-dark">星空観察</h3>
                <p className="text-gray-700 text-sm">
