  ...
  return (
    <div className="min-h-screen bg-natural-light py-16">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-serif font-bold mb-8 text-primary-dark text-center">心と体がよろこぶ食の会</h1>
        ...
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md mb-12">
          ...
          <h2 className="text-2xl font-serif font-bold mb-4 text-primary-dark">山荘ミルクの食へのこだわり</h2>
          <p className="text-gray-700 mb-6">
          ...
          <h2 className="text-2xl font-serif font-bold mb-4 text-primary-dark">酵素玄米</h2>
          ...
          <h2 className="text-2xl font-serif font-bold mb-4 text-primary-dark">こだわりの水</h2>
          <div className="bg-natural-light p-6 rounded-lg mb-6">
            <p className="text-gray-700 mb-4">
            ...
            <p className="text-gray-700">
              <em>※水の詳細な成分分析結果などの詳しい情報は近日公開予定です。</em>
            </p>
          </div>
          
          <h2 className="text-2xl font-serif font-bold mb-4 text-primary-dark">1秒1滴水出しコーヒー</h2>
          <div className="mb-8">
            {/* 実際のコーヒー写真に差し替え */}
          ...
          <h2 className="text-2xl font-serif font-bold mb-4 text-primary-dark">自然療法「ゴッドクリーナー」</h2>
          <div className="bg-natural-light p-6 rounded-lg mb-6">
            <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-serif font-bold mb-4 text-primary-dark">食の会の開催情報</h2>
          <div className="bg-natural-light p-6 rounded-lg mb-6">
            <h3 className="text-lg font-bold mb-2 text-primary-dark">開催日時</h3>
            <p className="text-gray-700 mb-4">
              毎月第2土曜日 13:00〜15:00
            </p>
            ...
            <h3 className="text-lg font-bold mb-2 text-primary-dark">お申し込み方法</h3>
            <p className="text-gray-700">
              電話またはメールにて、3日前までにお申し込みください。<br />
              電話: 0X0-XXXX-XXXX<br />
              メール: info@milk-co.jp
            </p>
          </div>
